    ...
    public void setScene(Scene scene) {
        ...
        buttonSaveImages.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                // -> maybe here lies the problem ?! -> mb build image with bufferedstream
        ...
        // catch mouse event
        // ! (get position in array) compare (OBJECTS !!!) clicked element with elements
        // of the arraylist<shapes> to get the position inside of that
        // ! (make it an obj with wrapperclass Integer)
        // ! (save position to arraylist<positions>)
        // ! (test if position was clicked before then remove it from
        // arraylist<positions>)
        // tilePane.addEventFilter(MouseEvent.MOUSE_PRESSED, e ->
        // System.out.println(e));
        // ! set listener tilepane to mark down which nodes are clicked by mouse
        // ! set REGION otherwise porogram just notices when clicked exactly on the
        // shape
